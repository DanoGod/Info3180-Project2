        ...
        <div class="d-flex align-items-center home-div col-md-12">
            <div class="row align-items-center col-md-6 intro">
                ...
                <div class="flex-area">
                    ...
                    <button @click="toLogin" class="btn text-white Subcolor" type="button">Login</button>
                </div>
            </div>
            <div class="fit col-md-6">
                <img class="" src="static/images/Lam.jpg">
            </div>
        </div>
    `,
    data() {
    ...
    template: `
        ...
        <div class="register m-4">
            ...
            <form method="POST" class="form" action="" id="register-form" @submit.prevent="registerUser()">
                ...
                <button type="submit" name="submit" class="btn  text-white mt-sm-3 mb-sm-1 Subcolor">Register</button>
            </form>
        </div>
        </div>
    `,
        ...
        registerUser: function() {
            ...
            .then(function(jsonResponse) {
                ...
                if(jsonResponse.errors==undefined){
                    router.push('/login');
                    swal({title: "Registration Successfull",text: jsonResponse.data.message,button: "Click Here To Continue"});
                }else{
                 swal({title: "Unsuccessful Registration",text: jsonResponse.errors[0],button: "Something went wrong"});    
                }
            })
    ...
    template: `
        <div class="center-form m-4 login">
            ...
            <form method="POST" class="form" action="" id="login-form" @submit.prevent="loginUser()">
                ...
                <button type="submit" name="submit" class="btn  text-white mt-sm-3 mb-sm-1 Subcolor login-field">Login</button>
            </form>
        </div>
    `,
    data() {
            ...
            .then(function(jsonResponse) {
                ...
                if(jsonResponse.errors==undefined){
                    if(jsonResponse.token !== null) {
                        ...
                        router.push('/explore');
                        swal({title: "Successfull",text: jsonResponse.data.message,button: "Click Here To Continue"});
                    }
                }else{
                    swal({title: "Unsuccessful",text: jsonResponse.errors[0],button: "Something went wrong"});  
                }
                ...
                <div id="explore-search">
                    <form id="explore-form" method="GET" @submit.prevent="search()">
                        ...
                        <div class="form-group search-btn-div">
                            <button type="submit" class="btn btn-success Subcolor search-btn">Search</button>
                            </div>
                    </form>
                </div>  
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="name-model-price">
                                ...
                                <a href="#" class="btn btn-success Subcolor card-price-btn">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="name-model-price">
                                ...
                                <a href="#" class="btn btn-success card-price-btn Subcolor">
                                    <img class="icons" src='/static/images/tagicon.png'>
                                    <span><span>$</span>{{cars.price}}</span>
                                </a>
...
const AddCar = {
    ...
    <div class="m-4 ">
        ...
        <form method="POST" class="form" action="" id="car-form" @submit.prevent="addCar()">
            ...
            <button type="submit" name="submit" class="btn Subcolor text-white mt-sm-3 mb-sm-1">Save</button>
        </form>
    </div>
    </div>
    `,
